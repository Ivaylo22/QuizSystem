...
const Login = ({setIsLoggedIn, setIsAdmin, setUserInformation}) => {
    ...
    }, [setUserInformation, setIsAdmin, setIsLoggedIn, navigate, location.state]);
        ...
        <div className="container pt-5 pb-2 login-container">
            <form onSubmit={handleSubmit} className="w-50 mx-auto">
                <div className="mb-3">
                    ...
                    <input type="email" name="email" className="form-control" placeholder="Имейл" value={formData.email}
